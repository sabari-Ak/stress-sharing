    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
          <Link 
            to="/signup" 
            className="w-full sm:w-auto px-10 py-4 rounded-2xl bg-primary hover:bg-primary/90 text-white font-semibold transition-all shadow-lg shadow-primary/20 hover:scale-105 active:scale-95"
          >
            Start Sharing - It's Free
          </Link>
          <Link 
            to="/login" 
            className="w-full sm:w-auto px-10 py-4 rounded-2xl border border-white/10 glass-card hover:bg-white/5 text-white font-semibold transition-all hover:scale-105 active:scale-95"
          >
...
const FeatureCard = ({ icon, title, description }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className="glass-card p-8 text-center text-sm border border-white/5"
  >
